...
2. Press **Ctrl+P** and paste `game.g.8d76d0a32049bbde9a8f.js:1:93141` then press enter, it should take you to a specific line in the code and highlight it orange so it's easy for you to find the position of the text cursor.
